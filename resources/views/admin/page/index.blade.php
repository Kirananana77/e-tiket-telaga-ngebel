        ...
        <div class="col-xl-3 col-md-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="header-title mt-0 mb-3">Total Penghasilan</h4>

                    <div class="widget-box-2">
                        <div class="widget-detail-2 text-end">
                        <span class="badge bg-pink rounded-pill float-start mt-3">{{ $totalRego ?? '' }}<i class="mdi mdi-trending-up"></i> </span>
